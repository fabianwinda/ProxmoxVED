...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/fabianwinda/ProxmoxVED → Fork (top right)
...
git remote add upstream https://github.com/fabianwinda/ProxmoxVED.git
...
- **GitHub**: https://github.com/fabianwinda/ProxmoxVED
- **Issues**: https://github.com/fabianwinda/ProxmoxVED/issues
- **Discussions**: https://github.com/fabianwinda/ProxmoxVED/discussions

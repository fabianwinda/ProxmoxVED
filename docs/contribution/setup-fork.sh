...
# upstream   https://github.com/fabianwinda/ProxmoxVED.git (fetch)
# upstream   https://github.com/fabianwinda/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/fabianwinda/ProxmoxVED"
echo ""
